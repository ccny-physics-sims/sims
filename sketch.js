...
function setup() {
  ...
  //V0 = 150//height of potential bump in pixels
  ...
  /*Left_checkbox = createCheckbox('Left',true)
  Right_checkbox = createCheckbox('Right',false)
  Left_checkbox.changed(Left_box_changed)
  Right_checkbox.changed(Right_box_changed)*/
  
  /*arrow_A = new Arrow(createVector(0,0),createVector(1,1))
  arrow_A.color = 'black'
  arrow_A.width = 10
  arrow_B = new Arrow(createVector(0,0),createVector(1,1))
  arrow_B.color = 'black'
  arrow_B.width = 10
  arrow_C = new Arrow(createVector(0,0),createVector(1,1))
  arrow_C.color = 'black'
  arrow_C.width = 10*/
