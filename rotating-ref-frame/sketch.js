...
function setup() {
  ...
  reset.position(windowWidth*.9,80);
...
function makescene() {
    ...
    ball = new KineticMass(pos,vel,accel,20,'green');
  ...
  ball2 = new KineticMass(p5.Vector.add(origin2, createVector(0,diskRadius)),ball2v0,accel,20,'purple');
